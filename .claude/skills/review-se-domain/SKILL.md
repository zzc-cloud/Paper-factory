...
Software Engineering 研究基于以下核心范式多

1. **工程化范式**多将系统化、量化的方法应用于软件开发
2. **迭代增量范式**多通过迭代和增量交付应对需求变化
3. **质量成本范式**多在开发早期投入质量保证，降低后期修复成本
4. **人本范式**多关注开发者体验、团队协作和组织文化
...
**敏捷方法**多Scrum, Kanban, XP, SAFe, LeSS

**CI/CD 工具**多Jenkins, GitLab CI, GitHub Actions, CircleCI

**测试工具**多JUnit, Selenium, Jest, PyTest

**代码质量工具**多SonarQube, ESLint, Pylint

### 领域特定评审问题

1. **敏捷适应**多敏捷流程如何适应团队规模和项目复杂度？

2. **CI/CD 失败处理**多CI/CD pipeline 如何处理测试失败？

3. **测试策略**多测试策略是否覆盖所有关键功能？

4. **技术债务量化**多如何量化和管理技术债务？

5. **代码质量**多代码质量如何持续改进？

6. **重构实践**多重构的频率和方法如何？

7. **团队协作**多团队协作如何支持工程实践？

8. **文档维护**多文档如何维护和更新？

9. **监控告警**多监控和告警如何设置？

10. **安全实践**多安全实践如何集成到开发流程？
