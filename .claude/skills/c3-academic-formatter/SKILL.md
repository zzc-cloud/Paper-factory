---
name: c3-academic-formatter
description: "学术格式化专家 — 组装章节、图表和参考文献，生成最终论文。"
---
...
`Skill(skill="c3-academic-formatter", args="{project}")`
...
2. `workspace/{project}/phase3/sections/` 目录包含章节文件
