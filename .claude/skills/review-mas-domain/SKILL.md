...
Multi-Agent Systems (MAS) 研究基于以下核心范式多

1. **分布式智能范式**多智能体通过协作解决单个智能体无法处理的复杂问题
2. **社会性范式**多智能体间通过通信、协商、协调形成社会性组织
3. **自组织范式**多系统通过局部交互涌现全局行为
4. **承诺与协作范式**多通过联合意图和联合承诺实现协同行为
...
**传统 MAS 系统**多JADE, Jason, MadKit, JACK

**现代 LLM-based MAS**多AutoGen, CrewAI, MetaGPT, AgentVerse, ChatDev

**协调协议**多Contract Net, Blackboard, Voting, 协商, 联合意图

**应用领域**多分布式优化、资源分配、多机器人协作、智能电网

### 领域特定评审问题

1. **BDI 模型完整性**多Agent 的 BDI 模型是否完整定义？信念如何更新？意图如何选择？

2. **通信可靠性**多通信协议如何处理消息丢失和顺序错乱？

3. **死锁分析**多协调机制是否能证明无死锁？

4. **可扩展性**多系统的可扩展性如何评估（节点数增加时的性能）？

5. **LLM 对比**多是否与最新的 AutoGen、CrewAI、MetaGPT 系统对比？

6. **组织演化**多组织结构是否动态调整？如何触发？

7. **容错性**多如何处理智能体失败？是否有恢复机制？

8. **承诺度**多智能体对意图的承诺度如何？是否有重新考虑机制？

9. **学习机制**多智能体是否能学习？学习什么（策略、模型、其他）？

10. **社会性**多智能体之间是否有社会规范？如何执行？
