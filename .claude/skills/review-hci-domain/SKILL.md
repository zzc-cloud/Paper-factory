...
Human-Computer Interaction (HCI) 研究基于以下核心范式：

1. **以用户为中心范式**：设计围绕用户需求、能力和限制展开
2. **迭代设计范式**：通过设计-评估-改进的循环优化用户体验
3. **情境化范式**：考虑使用场景、社会文化背景和环境因素
4. **可访问性范式**：确保设计对所有用户（包括残障用户）可用
...
**设计原则**：Nielsen's Heuristics, Shneiderman's 8 Golden Rules

**评估方法**：启发式评估、认知走查、用户测试、眼动追踪

**可访问性**：WCAG 2.1, Section 508

**研究方法**：访谈、问卷、观察、实验、案例研究

### 领域特定评审问题

1. **用户研究方法**：用户研究方法如何选择和执行？

2. **界面设计响应**：界面设计如何响应用户需求？

3. **可用性测试影响**：可用性测试结果如何影响设计决策？

4. **可访问性标准**：设计是否符合可访问性标准？

5. **用户体验改进**：用户体验如何持续改进？

6. **不同用户群体**：如何考虑不同用户群体的需求？
