...
├── templates/             # LaTeX 模板库（来源：OpenPrism MIT）
...
│       ├── requirements-spec/         # 需求规范协议（Spec-Then-Plan）
│       ├── research-interview/        # 研究访谈（6 阶段结构化访谈）
│       ├── research-ideation/         # 研究构思（3-5 方向生成）
│       ├── devils-advocate/           # 魔鬼代言人（批判性审查）
│       ├── quality-scorer/            # 量化评分引擎（100 分制）
